...
UpdateTargetDomainResult::UpdateTargetDomainResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

UpdateTargetDomainResult& UpdateTargetDomainResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {

...
StopNotebookRunResult::StopNotebookRunResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

StopNotebookRunResult& StopNotebookRunResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {

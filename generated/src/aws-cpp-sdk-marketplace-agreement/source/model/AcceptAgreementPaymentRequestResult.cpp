...
AcceptAgreementPaymentRequestResult::AcceptAgreementPaymentRequestResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

AcceptAgreementPaymentRequestResult& AcceptAgreementPaymentRequestResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {

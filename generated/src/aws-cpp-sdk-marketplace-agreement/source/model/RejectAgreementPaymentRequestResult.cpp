...
RejectAgreementPaymentRequestResult::RejectAgreementPaymentRequestResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

RejectAgreementPaymentRequestResult& RejectAgreementPaymentRequestResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {

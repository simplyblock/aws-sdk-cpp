...
RejectAgreementCancellationRequestResult::RejectAgreementCancellationRequestResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

RejectAgreementCancellationRequestResult& RejectAgreementCancellationRequestResult::operator=(

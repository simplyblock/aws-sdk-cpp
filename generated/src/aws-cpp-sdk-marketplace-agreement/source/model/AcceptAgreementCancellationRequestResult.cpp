...
AcceptAgreementCancellationRequestResult::AcceptAgreementCancellationRequestResult(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  *this = result;
}

AcceptAgreementCancellationRequestResult& AcceptAgreementCancellationRequestResult::operator=(

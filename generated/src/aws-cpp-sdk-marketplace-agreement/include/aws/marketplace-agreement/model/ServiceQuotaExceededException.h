...
/**
 * <p>Request exceeded the maximum allowed limit (quota) for a specific resource or
 * API operation.</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/marketplace-agreement-2020-03-01/ServiceQuotaExceededException">AWS
 * API Reference</a></p>
 */
class ServiceQuotaExceededException {
 public:
  AWS_AGREEMENTSERVICE_API ServiceQuotaExceededException() = default;
  AWS_AGREEMENTSERVICE_API ServiceQuotaExceededException(Aws::Utils::Json::JsonView jsonValue);
  AWS_AGREEMENTSERVICE_API ServiceQuotaExceededException& operator=(Aws::Utils::Json::JsonView jsonValue);

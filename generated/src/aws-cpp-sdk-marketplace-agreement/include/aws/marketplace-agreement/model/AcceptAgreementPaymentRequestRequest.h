...
/**
 */
class AcceptAgreementPaymentRequestRequest : public AgreementServiceRequest {
 public:
  AWS_AGREEMENTSERVICE_API AcceptAgreementPaymentRequestRequest() = default;

  // Service request name is the Operation name which will send this request out,
  // each operation should has unique request name, so that we can get operation's name from this request.
  // Note: this is not true for response, multiple operations may have the same response name,
  // so we can not get operation's name from response.
  inline virtual const char* GetServiceRequestName() const override { return "AcceptAgreementPaymentRequest"; }
  ...
  template <typename PaymentRequestIdT = Aws::String>
  AcceptAgreementPaymentRequestRequest& WithPaymentRequestId(PaymentRequestIdT&& value) {
  ...
  template <typename AgreementIdT = Aws::String>
  AcceptAgreementPaymentRequestRequest& WithAgreementId(AgreementIdT&& value) {
  ...
  ///@{
  /**
   * <p>An optional purchase order reference that buyers can provide to associate the
   * payment request with their internal purchase order system.</p>
   */
  ...
  template <typename PurchaseOrderReferenceT = Aws::String>
  AcceptAgreementPaymentRequestRequest& WithPurchaseOrderReference(PurchaseOrderReferenceT&& value) {

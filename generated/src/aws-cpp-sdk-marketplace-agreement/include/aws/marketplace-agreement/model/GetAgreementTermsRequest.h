...
class GetAgreementTermsRequest : public AgreementServiceRequest {
 public:
  ...
  template <typename AgreementIdT = Aws::String>
  GetAgreementTermsRequest& WithAgreementId(AgreementIdT&& value) {
  ...
  inline GetAgreementTermsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  GetAgreementTermsRequest& WithNextToken(NextTokenT&& value) {

...
namespace Model {
class RejectAgreementPaymentRequestResult {
 public:
  AWS_AGREEMENTSERVICE_API RejectAgreementPaymentRequestResult() = default;
  AWS_AGREEMENTSERVICE_API RejectAgreementPaymentRequestResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_AGREEMENTSERVICE_API RejectAgreementPaymentRequestResult& operator=(
  ...
  template <typename PaymentRequestIdT = Aws::String>
  RejectAgreementPaymentRequestResult& WithPaymentRequestId(PaymentRequestIdT&& value) {
  ...
  template <typename AgreementIdT = Aws::String>
  RejectAgreementPaymentRequestResult& WithAgreementId(AgreementIdT&& value) {
  ...
  inline RejectAgreementPaymentRequestResult& WithStatus(PaymentRequestStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  template <typename StatusMessageT = Aws::String>
  RejectAgreementPaymentRequestResult& WithStatusMessage(StatusMessageT&& value) {
  ...
  template <typename NameT = Aws::String>
  RejectAgreementPaymentRequestResult& WithName(NameT&& value) {
  ...
  template <typename DescriptionT = Aws::String>
  RejectAgreementPaymentRequestResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename ChargeAmountT = Aws::String>
  RejectAgreementPaymentRequestResult& WithChargeAmount(ChargeAmountT&& value) {
  ...
  template <typename CurrencyCodeT = Aws::String>
  RejectAgreementPaymentRequestResult& WithCurrencyCode(CurrencyCodeT&& value) {
  ...
  template <typename CreatedAtT = Aws::Utils::DateTime>
  RejectAgreementPaymentRequestResult& WithCreatedAt(CreatedAtT&& value) {
  ...
  template <typename UpdatedAtT = Aws::Utils::DateTime>
  RejectAgreementPaymentRequestResult& WithUpdatedAt(UpdatedAtT&& value) {
  ...
  template <typename RequestIdT = Aws::String>
  RejectAgreementPaymentRequestResult& WithRequestId(RequestIdT&& value) {

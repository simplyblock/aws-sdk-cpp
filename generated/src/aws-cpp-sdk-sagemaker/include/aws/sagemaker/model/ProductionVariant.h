...
class ProductionVariant {
 public:
  ...
  inline ProductionVariant& WithInitialInstanceCount(int value) {
  ...
  inline void SetInitialVariantWeight(double value) {
    m_initialVariantWeightHasBeenSet = true;
    m_initialVariantWeight = value;
  }
  inline ProductionVariant& WithInitialVariantWeight(double value) {
    SetInitialVariantWeight(value);
    return *this;
  }
  ///@}
  ...
  inline ProductionVariant& WithAcceleratorType(ProductionVariantAcceleratorType value) {
  ...
  void SetCoreDumpConfig(CoreDumpConfigT&& value) {
    ...
    m_coreDumpConfig = std::forward<CoreDumpConfigT>(value);
  }
  template <typename CoreDumpConfigT = ProductionVariantCoreDumpConfig>
  ProductionVariant& WithCoreDumpConfig(CoreDumpConfigT&& value) {
    SetCoreDumpConfig(std::forward<CoreDumpConfigT>(value));
    return *this;
  }
  ///@}
  ...
  inline ProductionVariant& WithVolumeSizeInGB(int value) {
  ...
  inline ProductionVariant& WithModelDataDownloadTimeoutInSeconds(int value) {
  ...
  inline ProductionVariant& WithContainerStartupHealthCheckTimeoutInSeconds(int value) {
  ...
  inline void SetEnableSSMAccess(bool value) {
    m_enableSSMAccessHasBeenSet = true;
    m_enableSSMAccess = value;
  }
  inline ProductionVariant& WithEnableSSMAccess(bool value) {
    SetEnableSSMAccess(value);
    return *this;
  }
  ///@}
   ...
   * mounting</p> </li> </ul> </dd> <dt>al2023-ami-sagemaker-inference-gpu-4-1</dt>
   * <dd> <ul> <li> <p>Accelerator: GPU</p> </li> <li> <p>NVIDIA driver version:
   * 580</p> </li> <li> <p>CUDA version: 13.0</p> </li> <li> <p>NVIDIA Container
   * Toolkit with disabled CUDA-compat mounting</p> </li> </ul> </dd>
   * <dt>al2-ami-sagemaker-inference-neuron-2</dt> <dd> <ul> <li> <p>Accelerator:
   * Inferentia2 and Trainium</p> </li> <li> <p>Neuron driver version: 2.19</p> </li>
   * </ul> </dd> </dl>
   */
  ...
  inline void SetInferenceAmiVersion(ProductionVariantInferenceAmiVersion value) {
    m_inferenceAmiVersionHasBeenSet = true;
    m_inferenceAmiVersion = value;
  }
  inline ProductionVariant& WithInferenceAmiVersion(ProductionVariantInferenceAmiVersion value) {
    SetInferenceAmiVersion(value);
    return *this;
  }
  ///@}

...
class DescribeInferenceComponentResult {
 public:
  ...
  inline DescribeInferenceComponentResult& WithInferenceComponentStatus(InferenceComponentStatus value) {
  ...
  void SetLastDeploymentConfig(LastDeploymentConfigT&& value) {
    ...
    m_lastDeploymentConfig = std::forward<LastDeploymentConfigT>(value);
  }
  template <typename LastDeploymentConfigT = InferenceComponentDeploymentConfig>
  DescribeInferenceComponentResult& WithLastDeploymentConfig(LastDeploymentConfigT&& value) {
    SetLastDeploymentConfig(std::forward<LastDeploymentConfigT>(value));
    return *this;
  }
  ///@}

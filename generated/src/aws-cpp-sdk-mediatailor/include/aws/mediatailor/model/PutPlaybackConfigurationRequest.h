...
class PutPlaybackConfigurationRequest : public MediaTailorRequest {
 public:
  ...
  inline PutPlaybackConfigurationRequest& WithInsertionMode(InsertionMode value) {
  ...
  template <typename NameT = Aws::String>
  PutPlaybackConfigurationRequest& WithName(NameT&& value) {
  ...
  inline PutPlaybackConfigurationRequest& WithPersonalizationThresholdSeconds(int value) {
  ...
  template <typename TagsT = Aws::Map<Aws::String, Aws::String>>
  PutPlaybackConfigurationRequest& WithTags(TagsT&& value) {
  ...
  template <typename FunctionMappingT = Aws::Map<EventName, Aws::String>>
  PutPlaybackConfigurationRequest& WithFunctionMapping(FunctionMappingT&& value) {
    SetFunctionMapping(std::forward<FunctionMappingT>(value));
    return *this;
  }
  inline PutPlaybackConfigurationRequest& AddFunctionMapping(EventName key, Aws::String value) {
    m_functionMappingHasBeenSet = true;

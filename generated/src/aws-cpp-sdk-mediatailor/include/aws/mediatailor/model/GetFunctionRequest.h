...
/**
 * <p>-- Request/Response DataStructures --</p><p><h3>See Also:</h3>   <a
 * href="http://docs.aws.amazon.com/goto/WebAPI/mediatailor-2018-04-23/GetFunctionRequest">AWS
 * API Reference</a></p>
 */
class GetFunctionRequest : public MediaTailorRequest {
 public:
  AWS_MEDIATAILOR_API GetFunctionRequest() = default;

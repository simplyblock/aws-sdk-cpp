...
/**
 */
class ListFunctionsRequest : public MediaTailorRequest {
 public:
  AWS_MEDIATAILOR_API ListFunctionsRequest() = default;
  ...
  ///@{
  /**
   * <p>The maximum number of functions that you want MediaTailor to return in
   * response to the current request. If there are more than <code>MaxResults</code>
   * functions, use the value of <code>NextToken</code> in the response to get the
   * next page of results.</p> <p>The default value is 100. MediaTailor uses
   * token-based pagination, which means that a response might contain fewer than
  ...
  inline ListFunctionsRequest& WithMaxResults(int value) {
    SetMaxResults(value);
    return *this;
  }
  ///@}
  ...
  template <typename NextTokenT = Aws::String>
  ListFunctionsRequest& WithNextToken(NextTokenT&& value) {

 ...
 * href="http://docs.aws.amazon.com/goto/WebAPI/mediatailor-2018-04-23/GetFunctionResponse">AWS
 * API Reference</a></p>
 */
class GetFunctionResult {
 public:
  AWS_MEDIATAILOR_API GetFunctionResult() = default;
  AWS_MEDIATAILOR_API GetFunctionResult(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  AWS_MEDIATAILOR_API GetFunctionResult& operator=(const Aws::AmazonWebServiceResult<Aws::Utils::Json::JsonValue>& result);
  ...
  template <typename FunctionIdT = Aws::String>
  GetFunctionResult& WithFunctionId(FunctionIdT&& value) {
  ...
  inline GetFunctionResult& WithFunctionType(FunctionType value) {
  ...
  template <typename DescriptionT = Aws::String>
  GetFunctionResult& WithDescription(DescriptionT&& value) {
  ...
  template <typename HttpRequestConfigurationT = HttpRequestConfiguration>
  GetFunctionResult& WithHttpRequestConfiguration(HttpRequestConfigurationT&& value) {
  ...
  template <typename CustomOutputConfigurationT = CustomOutputConfiguration>
  GetFunctionResult& WithCustomOutputConfiguration(CustomOutputConfigurationT&& value) {
  ...
  template <typename SequentialExecutorConfigurationT = SequentialExecutorConfiguration>
  GetFunctionResult& WithSequentialExecutorConfiguration(SequentialExecutorConfigurationT&& value) {
  ...
  template <typename ArnT = Aws::String>
  GetFunctionResult& WithArn(ArnT&& value) {

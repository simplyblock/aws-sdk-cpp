...
class AWS_SECURITYHUB_API SecurityHubClient : public Aws::Client::AWSJsonClient,
 ...
 public:
   ...
   */
  SecurityHubClient(
      const Aws::Auth::AWSCredentials& credentials, std::shared_ptr<SecurityHubEndpointProviderBase> endpointProvider = nullptr,
      const Aws::SecurityHub::SecurityHubClientConfiguration& clientConfiguration = Aws::SecurityHub::SecurityHubClientConfiguration());
  ...
  virtual Model::AcceptAdministratorInvitationOutcome AcceptAdministratorInvitation(
      const Model::AcceptAdministratorInvitationRequest& request) const;

  /**
   * A Callable wrapper for AcceptAdministratorInvitation that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename AcceptAdministratorInvitationRequestT = Model::AcceptAdministratorInvitationRequest>
  Model::AcceptAdministratorInvitationOutcomeCallable AcceptAdministratorInvitationCallable(
      const AcceptAdministratorInvitationRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::AcceptAdministratorInvitation, request);
  }

  /**
   * An Async wrapper for AcceptAdministratorInvitation that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename AcceptAdministratorInvitationRequestT = Model::AcceptAdministratorInvitationRequest>
  void AcceptAdministratorInvitationAsync(const AcceptAdministratorInvitationRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchDeleteAutomationRulesOutcome BatchDeleteAutomationRules(
      const Model::BatchDeleteAutomationRulesRequest& request) const;

  /**
   * A Callable wrapper for BatchDeleteAutomationRules that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchDeleteAutomationRulesRequestT = Model::BatchDeleteAutomationRulesRequest>
  Model::BatchDeleteAutomationRulesOutcomeCallable BatchDeleteAutomationRulesCallable(
      const BatchDeleteAutomationRulesRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::BatchDeleteAutomationRules, request);
  }

  /**
   * An Async wrapper for BatchDeleteAutomationRules that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDeleteAutomationRulesRequestT = Model::BatchDeleteAutomationRulesRequest>
  void BatchDeleteAutomationRulesAsync(const BatchDeleteAutomationRulesRequestT& request,
                                       const BatchDeleteAutomationRulesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchDisableStandards that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchDisableStandards that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchDisableStandardsRequestT = Model::BatchDisableStandardsRequest>
  void BatchDisableStandardsAsync(const BatchDisableStandardsRequestT& request, const BatchDisableStandardsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchEnableStandards that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchEnableStandards that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchEnableStandardsRequestT = Model::BatchEnableStandardsRequest>
  void BatchEnableStandardsAsync(const BatchEnableStandardsRequestT& request, const BatchEnableStandardsResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetAutomationRules that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetAutomationRules that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetAutomationRulesRequestT = Model::BatchGetAutomationRulesRequest>
  void BatchGetAutomationRulesAsync(const BatchGetAutomationRulesRequestT& request,
                                    const BatchGetAutomationRulesResponseReceivedHandler& handler,
                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchGetConfigurationPolicyAssociationsOutcome BatchGetConfigurationPolicyAssociations(
      const Model::BatchGetConfigurationPolicyAssociationsRequest& request) const;

  /**
   * A Callable wrapper for BatchGetConfigurationPolicyAssociations that returns a future to the operation so that it can be executed in
  ...
  Model::BatchGetConfigurationPolicyAssociationsOutcomeCallable BatchGetConfigurationPolicyAssociationsCallable(
      const BatchGetConfigurationPolicyAssociationsRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::BatchGetConfigurationPolicyAssociations, request);
  }

  /**
   * An Async wrapper for BatchGetConfigurationPolicyAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchGetConfigurationPolicyAssociationsRequestT = Model::BatchGetConfigurationPolicyAssociationsRequest>
  void BatchGetConfigurationPolicyAssociationsAsync(const BatchGetConfigurationPolicyAssociationsRequestT& request,
                                                    const BatchGetConfigurationPolicyAssociationsResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchGetSecurityControls that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchGetSecurityControls that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchGetSecurityControlsRequestT = Model::BatchGetSecurityControlsRequest>
  void BatchGetSecurityControlsAsync(const BatchGetSecurityControlsRequestT& request,
                                     const BatchGetSecurityControlsResponseReceivedHandler& handler,
                                     const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchGetStandardsControlAssociationsOutcome BatchGetStandardsControlAssociations(
      const Model::BatchGetStandardsControlAssociationsRequest& request) const;

  /**
   * A Callable wrapper for BatchGetStandardsControlAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename BatchGetStandardsControlAssociationsRequestT = Model::BatchGetStandardsControlAssociationsRequest>
  Model::BatchGetStandardsControlAssociationsOutcomeCallable BatchGetStandardsControlAssociationsCallable(
      const BatchGetStandardsControlAssociationsRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::BatchGetStandardsControlAssociations, request);
  }

  /**
   * An Async wrapper for BatchGetStandardsControlAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchGetStandardsControlAssociationsRequestT = Model::BatchGetStandardsControlAssociationsRequest>
  void BatchGetStandardsControlAssociationsAsync(const BatchGetStandardsControlAssociationsRequestT& request,
                                                 const BatchGetStandardsControlAssociationsResponseReceivedHandler& handler,
                                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchImportFindings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchImportFindings that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchImportFindingsRequestT = Model::BatchImportFindingsRequest>
  void BatchImportFindingsAsync(const BatchImportFindingsRequestT& request, const BatchImportFindingsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::BatchUpdateAutomationRulesOutcome BatchUpdateAutomationRules(
      const Model::BatchUpdateAutomationRulesRequest& request) const;

  /**
   * A Callable wrapper for BatchUpdateAutomationRules that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename BatchUpdateAutomationRulesRequestT = Model::BatchUpdateAutomationRulesRequest>
  Model::BatchUpdateAutomationRulesOutcomeCallable BatchUpdateAutomationRulesCallable(
      const BatchUpdateAutomationRulesRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::BatchUpdateAutomationRules, request);
  }

  /**
   * An Async wrapper for BatchUpdateAutomationRules that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchUpdateAutomationRulesRequestT = Model::BatchUpdateAutomationRulesRequest>
  void BatchUpdateAutomationRulesAsync(const BatchUpdateAutomationRulesRequestT& request,
                                       const BatchUpdateAutomationRulesResponseReceivedHandler& handler,
                                       const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchUpdateFindings that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchUpdateFindings that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename BatchUpdateFindingsRequestT = Model::BatchUpdateFindingsRequest>
  void BatchUpdateFindingsAsync(const BatchUpdateFindingsRequestT& request, const BatchUpdateFindingsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for BatchUpdateFindingsV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for BatchUpdateFindingsV2 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename BatchUpdateFindingsV2RequestT = Model::BatchUpdateFindingsV2Request>
  void BatchUpdateFindingsV2Async(const BatchUpdateFindingsV2ResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const BatchUpdateFindingsV2RequestT& request = {}) const {
  ...
  virtual Model::BatchUpdateStandardsControlAssociationsOutcome BatchUpdateStandardsControlAssociations(
      const Model::BatchUpdateStandardsControlAssociationsRequest& request) const;

  /**
   * A Callable wrapper for BatchUpdateStandardsControlAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename BatchUpdateStandardsControlAssociationsRequestT = Model::BatchUpdateStandardsControlAssociationsRequest>
  Model::BatchUpdateStandardsControlAssociationsOutcomeCallable BatchUpdateStandardsControlAssociationsCallable(
      const BatchUpdateStandardsControlAssociationsRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::BatchUpdateStandardsControlAssociations, request);
  }

  /**
   * An Async wrapper for BatchUpdateStandardsControlAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename BatchUpdateStandardsControlAssociationsRequestT = Model::BatchUpdateStandardsControlAssociationsRequest>
  void BatchUpdateStandardsControlAssociationsAsync(const BatchUpdateStandardsControlAssociationsRequestT& request,
                                                    const BatchUpdateStandardsControlAssociationsResponseReceivedHandler& handler,
                                                    const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateActionTarget that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateActionTarget that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateActionTargetRequestT = Model::CreateActionTargetRequest>
  void CreateActionTargetAsync(const CreateActionTargetRequestT& request, const CreateActionTargetResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAggregatorV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAggregatorV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateAggregatorV2RequestT = Model::CreateAggregatorV2Request>
  void CreateAggregatorV2Async(const CreateAggregatorV2RequestT& request, const CreateAggregatorV2ResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateAutomationRuleV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateAutomationRuleV2 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateAutomationRuleV2RequestT = Model::CreateAutomationRuleV2Request>
  void CreateAutomationRuleV2Async(const CreateAutomationRuleV2RequestT& request,
                                   const CreateAutomationRuleV2ResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateConfigurationPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename CreateConfigurationPolicyRequestT = Model::CreateConfigurationPolicyRequest>
  Model::CreateConfigurationPolicyOutcomeCallable CreateConfigurationPolicyCallable(
      const CreateConfigurationPolicyRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::CreateConfigurationPolicy, request);
  }

  /**
   * An Async wrapper for CreateConfigurationPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateConfigurationPolicyRequestT = Model::CreateConfigurationPolicyRequest>
  void CreateConfigurationPolicyAsync(const CreateConfigurationPolicyRequestT& request,
                                      const CreateConfigurationPolicyResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateConnectorV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateConnectorV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename CreateConnectorV2RequestT = Model::CreateConnectorV2Request>
  void CreateConnectorV2Async(const CreateConnectorV2RequestT& request, const CreateConnectorV2ResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for CreateFindingAggregator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for CreateFindingAggregator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename CreateFindingAggregatorRequestT = Model::CreateFindingAggregatorRequest>
  void CreateFindingAggregatorAsync(const CreateFindingAggregatorRequestT& request,
  ...
  /**
   * An Async wrapper for CreateInsight that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateInsightRequestT = Model::CreateInsightRequest>
  void CreateInsightAsync(const CreateInsightRequestT& request, const CreateInsightResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for CreateTicketV2 that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename CreateTicketV2RequestT = Model::CreateTicketV2Request>
  void CreateTicketV2Async(const CreateTicketV2RequestT& request, const CreateTicketV2ResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteActionTarget that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteActionTarget that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteActionTargetRequestT = Model::DeleteActionTargetRequest>
  void DeleteActionTargetAsync(const DeleteActionTargetRequestT& request, const DeleteActionTargetResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAggregatorV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAggregatorV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteAggregatorV2RequestT = Model::DeleteAggregatorV2Request>
  void DeleteAggregatorV2Async(const DeleteAggregatorV2RequestT& request, const DeleteAggregatorV2ResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteAutomationRuleV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteAutomationRuleV2 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteAutomationRuleV2RequestT = Model::DeleteAutomationRuleV2Request>
  void DeleteAutomationRuleV2Async(const DeleteAutomationRuleV2RequestT& request,
                                   const DeleteAutomationRuleV2ResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteConfigurationPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DeleteConfigurationPolicyRequestT = Model::DeleteConfigurationPolicyRequest>
  Model::DeleteConfigurationPolicyOutcomeCallable DeleteConfigurationPolicyCallable(
      const DeleteConfigurationPolicyRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::DeleteConfigurationPolicy, request);
  }

  /**
   * An Async wrapper for DeleteConfigurationPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteConfigurationPolicyRequestT = Model::DeleteConfigurationPolicyRequest>
  void DeleteConfigurationPolicyAsync(const DeleteConfigurationPolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for DeleteConnectorV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteConnectorV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DeleteConnectorV2RequestT = Model::DeleteConnectorV2Request>
  void DeleteConnectorV2Async(const DeleteConnectorV2RequestT& request, const DeleteConnectorV2ResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for DeleteFindingAggregator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DeleteFindingAggregator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DeleteFindingAggregatorRequestT = Model::DeleteFindingAggregatorRequest>
  void DeleteFindingAggregatorAsync(const DeleteFindingAggregatorRequestT& request,
  ...
  /**
   * A Callable wrapper for DescribeActionTargets that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeActionTargets that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeActionTargetsRequestT = Model::DescribeActionTargetsRequest>
  void DescribeActionTargetsAsync(const DescribeActionTargetsResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeActionTargetsRequestT& request = {}) const {
   ...
   */
  template <typename DescribeHubRequestT = Model::DescribeHubRequest>
  void DescribeHubAsync(const DescribeHubResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const DescribeHubRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeProducts that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeProducts that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeProductsRequestT = Model::DescribeProductsRequest>
  void DescribeProductsAsync(const DescribeProductsResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const DescribeProductsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeProductsV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeProductsV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeProductsV2RequestT = Model::DescribeProductsV2Request>
  void DescribeProductsV2Async(const DescribeProductsV2ResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DescribeProductsV2RequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeSecurityHubV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeSecurityHubV2 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeSecurityHubV2RequestT = Model::DescribeSecurityHubV2Request>
  void DescribeSecurityHubV2Async(const DescribeSecurityHubV2ResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const DescribeSecurityHubV2RequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeStandards that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DescribeStandards that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DescribeStandardsRequestT = Model::DescribeStandardsRequest>
  void DescribeStandardsAsync(const DescribeStandardsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const DescribeStandardsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DescribeStandardsControls that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename DescribeStandardsControlsRequestT = Model::DescribeStandardsControlsRequest>
  Model::DescribeStandardsControlsOutcomeCallable DescribeStandardsControlsCallable(
      const DescribeStandardsControlsRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::DescribeStandardsControls, request);
  }

  /**
   * An Async wrapper for DescribeStandardsControls that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DescribeStandardsControlsRequestT = Model::DescribeStandardsControlsRequest>
  void DescribeStandardsControlsAsync(const DescribeStandardsControlsRequestT& request,
   ...
   * API Reference</a></p>
   */
  virtual Model::DisableImportFindingsForProductOutcome DisableImportFindingsForProduct(
      const Model::DisableImportFindingsForProductRequest& request) const;

  /**
   * A Callable wrapper for DisableImportFindingsForProduct that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename DisableImportFindingsForProductRequestT = Model::DisableImportFindingsForProductRequest>
  Model::DisableImportFindingsForProductOutcomeCallable DisableImportFindingsForProductCallable(
      const DisableImportFindingsForProductRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::DisableImportFindingsForProduct, request);
  }

  /**
   * An Async wrapper for DisableImportFindingsForProduct that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename DisableImportFindingsForProductRequestT = Model::DisableImportFindingsForProductRequest>
  void DisableImportFindingsForProductAsync(const DisableImportFindingsForProductRequestT& request,
  ...
  /**
   * A Callable wrapper for DisableSecurityHub that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisableSecurityHub that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisableSecurityHubRequestT = Model::DisableSecurityHubRequest>
  void DisableSecurityHubAsync(const DisableSecurityHubResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                               const DisableSecurityHubRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DisableSecurityHubV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisableSecurityHubV2 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename DisableSecurityHubV2RequestT = Model::DisableSecurityHubV2Request>
  void DisableSecurityHubV2Async(const DisableSecurityHubV2ResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                 const DisableSecurityHubV2RequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for DisassociateMembers that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for DisassociateMembers that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename DisassociateMembersRequestT = Model::DisassociateMembersRequest>
  void DisassociateMembersAsync(const DisassociateMembersRequestT& request, const DisassociateMembersResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::EnableImportFindingsForProductOutcome EnableImportFindingsForProduct(
      const Model::EnableImportFindingsForProductRequest& request) const;

  /**
   * A Callable wrapper for EnableImportFindingsForProduct that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename EnableImportFindingsForProductRequestT = Model::EnableImportFindingsForProductRequest>
  Model::EnableImportFindingsForProductOutcomeCallable EnableImportFindingsForProductCallable(
      const EnableImportFindingsForProductRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::EnableImportFindingsForProduct, request);
  }

  /**
   * An Async wrapper for EnableImportFindingsForProduct that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename EnableImportFindingsForProductRequestT = Model::EnableImportFindingsForProductRequest>
  void EnableImportFindingsForProductAsync(const EnableImportFindingsForProductRequestT& request,
  ...
  /**
   * A Callable wrapper for EnableSecurityHub that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EnableSecurityHub that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename EnableSecurityHubRequestT = Model::EnableSecurityHubRequest>
  void EnableSecurityHubAsync(const EnableSecurityHubResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
  ...
  /**
   * A Callable wrapper for EnableSecurityHubV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for EnableSecurityHubV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename EnableSecurityHubV2RequestT = Model::EnableSecurityHubV2Request>
  void EnableSecurityHubV2Async(const EnableSecurityHubV2ResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const EnableSecurityHubV2RequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetAggregatorV2 that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetAggregatorV2RequestT = Model::GetAggregatorV2Request>
  void GetAggregatorV2Async(const GetAggregatorV2RequestT& request, const GetAggregatorV2ResponseReceivedHandler& handler,
                            const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetAutomationRuleV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetAutomationRuleV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetAutomationRuleV2RequestT = Model::GetAutomationRuleV2Request>
  void GetAutomationRuleV2Async(const GetAutomationRuleV2RequestT& request, const GetAutomationRuleV2ResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetConfigurationPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetConfigurationPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetConfigurationPolicyRequestT = Model::GetConfigurationPolicyRequest>
  void GetConfigurationPolicyAsync(const GetConfigurationPolicyRequestT& request,
                                   const GetConfigurationPolicyResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetConfigurationPolicyAssociationOutcome GetConfigurationPolicyAssociation(
      const Model::GetConfigurationPolicyAssociationRequest& request) const;

  /**
   * A Callable wrapper for GetConfigurationPolicyAssociation that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename GetConfigurationPolicyAssociationRequestT = Model::GetConfigurationPolicyAssociationRequest>
  Model::GetConfigurationPolicyAssociationOutcomeCallable GetConfigurationPolicyAssociationCallable(
      const GetConfigurationPolicyAssociationRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::GetConfigurationPolicyAssociation, request);
  }

  /**
   * An Async wrapper for GetConfigurationPolicyAssociation that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename GetConfigurationPolicyAssociationRequestT = Model::GetConfigurationPolicyAssociationRequest>
  void GetConfigurationPolicyAssociationAsync(const GetConfigurationPolicyAssociationRequestT& request,
  ...
  /**
   * An Async wrapper for GetConnectorV2 that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetConnectorV2RequestT = Model::GetConnectorV2Request>
  void GetConnectorV2Async(const GetConnectorV2RequestT& request, const GetConnectorV2ResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetEnabledStandards that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetEnabledStandards that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetEnabledStandardsRequestT = Model::GetEnabledStandardsRequest>
  void GetEnabledStandardsAsync(const GetEnabledStandardsResponseReceivedHandler& handler,
                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                const GetEnabledStandardsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetFindingAggregator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFindingAggregator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetFindingAggregatorRequestT = Model::GetFindingAggregatorRequest>
  void GetFindingAggregatorAsync(const GetFindingAggregatorRequestT& request, const GetFindingAggregatorResponseReceivedHandler& handler,
                                 const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetFindingHistory that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFindingHistory that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetFindingHistoryRequestT = Model::GetFindingHistoryRequest>
  void GetFindingHistoryAsync(const GetFindingHistoryRequestT& request, const GetFindingHistoryResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for GetFindingStatisticsV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetFindingStatisticsV2 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetFindingStatisticsV2RequestT = Model::GetFindingStatisticsV2Request>
  void GetFindingStatisticsV2Async(const GetFindingStatisticsV2RequestT& request,
                                   const GetFindingStatisticsV2ResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   */
  template <typename GetFindingsRequestT = Model::GetFindingsRequest>
  void GetFindingsAsync(const GetFindingsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const GetFindingsRequestT& request = {}) const {
  ...
  /**
   * An Async wrapper for GetFindingsV2 that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetFindingsV2RequestT = Model::GetFindingsV2Request>
  void GetFindingsV2Async(const GetFindingsV2ResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                          const GetFindingsV2RequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetInsightResults that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetInsightResults that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename GetInsightResultsRequestT = Model::GetInsightResultsRequest>
  void GetInsightResultsAsync(const GetInsightResultsRequestT& request, const GetInsightResultsResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for GetInsights that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetInsightsRequestT = Model::GetInsightsRequest>
  void GetInsightsAsync(const GetInsightsResponseReceivedHandler& handler,
                        const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                        const GetInsightsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for GetResourcesStatisticsV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for GetResourcesStatisticsV2 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetResourcesStatisticsV2RequestT = Model::GetResourcesStatisticsV2Request>
  void GetResourcesStatisticsV2Async(const GetResourcesStatisticsV2RequestT& request,
  ...
  /**
   * An Async wrapper for GetResourcesV2 that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename GetResourcesV2RequestT = Model::GetResourcesV2Request>
  void GetResourcesV2Async(const GetResourcesV2ResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                           const GetResourcesV2RequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::GetSecurityControlDefinitionOutcome GetSecurityControlDefinition(
      const Model::GetSecurityControlDefinitionRequest& request) const;

  /**
   * A Callable wrapper for GetSecurityControlDefinition that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename GetSecurityControlDefinitionRequestT = Model::GetSecurityControlDefinitionRequest>
  Model::GetSecurityControlDefinitionOutcomeCallable GetSecurityControlDefinitionCallable(
      const GetSecurityControlDefinitionRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::GetSecurityControlDefinition, request);
  }

  /**
   * An Async wrapper for GetSecurityControlDefinition that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename GetSecurityControlDefinitionRequestT = Model::GetSecurityControlDefinitionRequest>
  void GetSecurityControlDefinitionAsync(const GetSecurityControlDefinitionRequestT& request,
                                         const GetSecurityControlDefinitionResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for InviteMembers that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename InviteMembersRequestT = Model::InviteMembersRequest>
  void InviteMembersAsync(const InviteMembersRequestT& request, const InviteMembersResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for ListAggregatorsV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAggregatorsV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListAggregatorsV2RequestT = Model::ListAggregatorsV2Request>
  void ListAggregatorsV2Async(const ListAggregatorsV2ResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                              const ListAggregatorsV2RequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListAutomationRulesV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListAutomationRulesV2 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListAutomationRulesV2RequestT = Model::ListAutomationRulesV2Request>
  void ListAutomationRulesV2Async(const ListAutomationRulesV2ResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                  const ListAutomationRulesV2RequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListConfigurationPoliciesOutcome ListConfigurationPolicies(
      const Model::ListConfigurationPoliciesRequest& request = {}) const;

  /**
   * A Callable wrapper for ListConfigurationPolicies that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename ListConfigurationPoliciesRequestT = Model::ListConfigurationPoliciesRequest>
  Model::ListConfigurationPoliciesOutcomeCallable ListConfigurationPoliciesCallable(
      const ListConfigurationPoliciesRequestT& request = {}) const {
    return SubmitCallable(&SecurityHubClient::ListConfigurationPolicies, request);
  }

  /**
   * An Async wrapper for ListConfigurationPolicies that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListConfigurationPoliciesRequestT = Model::ListConfigurationPoliciesRequest>
  void ListConfigurationPoliciesAsync(const ListConfigurationPoliciesResponseReceivedHandler& handler,
                                      const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                      const ListConfigurationPoliciesRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListConfigurationPolicyAssociationsOutcome ListConfigurationPolicyAssociations(
      const Model::ListConfigurationPolicyAssociationsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListConfigurationPolicyAssociations that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename ListConfigurationPolicyAssociationsRequestT = Model::ListConfigurationPolicyAssociationsRequest>
  Model::ListConfigurationPolicyAssociationsOutcomeCallable ListConfigurationPolicyAssociationsCallable(
  ...
  /**
   * An Async wrapper for ListConfigurationPolicyAssociations that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename ListConfigurationPolicyAssociationsRequestT = Model::ListConfigurationPolicyAssociationsRequest>
  void ListConfigurationPolicyAssociationsAsync(const ListConfigurationPolicyAssociationsResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                                const ListConfigurationPolicyAssociationsRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListConnectorsV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListConnectorsV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename ListConnectorsV2RequestT = Model::ListConnectorsV2Request>
  void ListConnectorsV2Async(const ListConnectorsV2ResponseReceivedHandler& handler,
                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                             const ListConnectorsV2RequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListEnabledProductsForImportOutcome ListEnabledProductsForImport(
      const Model::ListEnabledProductsForImportRequest& request = {}) const;

  /**
   * A Callable wrapper for ListEnabledProductsForImport that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListEnabledProductsForImportRequestT = Model::ListEnabledProductsForImportRequest>
  Model::ListEnabledProductsForImportOutcomeCallable ListEnabledProductsForImportCallable(
  ...
  /**
   * An Async wrapper for ListEnabledProductsForImport that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListEnabledProductsForImportRequestT = Model::ListEnabledProductsForImportRequest>
  void ListEnabledProductsForImportAsync(const ListEnabledProductsForImportResponseReceivedHandler& handler,
                                         const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                         const ListEnabledProductsForImportRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for ListFindingAggregators that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for ListFindingAggregators that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename ListFindingAggregatorsRequestT = Model::ListFindingAggregatorsRequest>
  void ListFindingAggregatorsAsync(const ListFindingAggregatorsResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                   const ListFindingAggregatorsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListSecurityControlDefinitionsOutcome ListSecurityControlDefinitions(
      const Model::ListSecurityControlDefinitionsRequest& request = {}) const;

  /**
   * A Callable wrapper for ListSecurityControlDefinitions that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename ListSecurityControlDefinitionsRequestT = Model::ListSecurityControlDefinitionsRequest>
  Model::ListSecurityControlDefinitionsOutcomeCallable ListSecurityControlDefinitionsCallable(
      const ListSecurityControlDefinitionsRequestT& request = {}) const {
    return SubmitCallable(&SecurityHubClient::ListSecurityControlDefinitions, request);
  }

  /**
   * An Async wrapper for ListSecurityControlDefinitions that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListSecurityControlDefinitionsRequestT = Model::ListSecurityControlDefinitionsRequest>
  void ListSecurityControlDefinitionsAsync(const ListSecurityControlDefinitionsResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const ListSecurityControlDefinitionsRequestT& request = {}) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::ListStandardsControlAssociationsOutcome ListStandardsControlAssociations(
      const Model::ListStandardsControlAssociationsRequest& request) const;

  /**
   * A Callable wrapper for ListStandardsControlAssociations that returns a future to the operation so that it can be executed in parallel
   * to other requests.
   */
  template <typename ListStandardsControlAssociationsRequestT = Model::ListStandardsControlAssociationsRequest>
  Model::ListStandardsControlAssociationsOutcomeCallable ListStandardsControlAssociationsCallable(
      const ListStandardsControlAssociationsRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::ListStandardsControlAssociations, request);
  }

  /**
   * An Async wrapper for ListStandardsControlAssociations that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename ListStandardsControlAssociationsRequestT = Model::ListStandardsControlAssociationsRequest>
  void ListStandardsControlAssociationsAsync(const ListStandardsControlAssociationsRequestT& request,
                                             const ListStandardsControlAssociationsResponseReceivedHandler& handler,
                                             const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartConfigurationPolicyAssociationOutcome StartConfigurationPolicyAssociation(
      const Model::StartConfigurationPolicyAssociationRequest& request) const;

  /**
   * A Callable wrapper for StartConfigurationPolicyAssociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename StartConfigurationPolicyAssociationRequestT = Model::StartConfigurationPolicyAssociationRequest>
  Model::StartConfigurationPolicyAssociationOutcomeCallable StartConfigurationPolicyAssociationCallable(
      const StartConfigurationPolicyAssociationRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::StartConfigurationPolicyAssociation, request);
  }

  /**
   * An Async wrapper for StartConfigurationPolicyAssociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StartConfigurationPolicyAssociationRequestT = Model::StartConfigurationPolicyAssociationRequest>
  void StartConfigurationPolicyAssociationAsync(const StartConfigurationPolicyAssociationRequestT& request,
                                                const StartConfigurationPolicyAssociationResponseReceivedHandler& handler,
                                                const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::StartConfigurationPolicyDisassociationOutcome StartConfigurationPolicyDisassociation(
      const Model::StartConfigurationPolicyDisassociationRequest& request) const;

  /**
   * A Callable wrapper for StartConfigurationPolicyDisassociation that returns a future to the operation so that it can be executed in
   * parallel to other requests.
   */
  template <typename StartConfigurationPolicyDisassociationRequestT = Model::StartConfigurationPolicyDisassociationRequest>
  Model::StartConfigurationPolicyDisassociationOutcomeCallable StartConfigurationPolicyDisassociationCallable(
      const StartConfigurationPolicyDisassociationRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::StartConfigurationPolicyDisassociation, request);
  }

  /**
   * An Async wrapper for StartConfigurationPolicyDisassociation that queues the request into a thread executor and triggers associated
   * callback when operation has finished.
   */
  template <typename StartConfigurationPolicyDisassociationRequestT = Model::StartConfigurationPolicyDisassociationRequest>
  void StartConfigurationPolicyDisassociationAsync(const StartConfigurationPolicyDisassociationRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateActionTarget that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateActionTarget that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateActionTargetRequestT = Model::UpdateActionTargetRequest>
  void UpdateActionTargetAsync(const UpdateActionTargetRequestT& request, const UpdateActionTargetResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAggregatorV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAggregatorV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateAggregatorV2RequestT = Model::UpdateAggregatorV2Request>
  void UpdateAggregatorV2Async(const UpdateAggregatorV2RequestT& request, const UpdateAggregatorV2ResponseReceivedHandler& handler,
                               const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateAutomationRuleV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateAutomationRuleV2 that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateAutomationRuleV2RequestT = Model::UpdateAutomationRuleV2Request>
  void UpdateAutomationRuleV2Async(const UpdateAutomationRuleV2RequestT& request,
                                   const UpdateAutomationRuleV2ResponseReceivedHandler& handler,
                                   const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateConfigurationPolicy that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  template <typename UpdateConfigurationPolicyRequestT = Model::UpdateConfigurationPolicyRequest>
  Model::UpdateConfigurationPolicyOutcomeCallable UpdateConfigurationPolicyCallable(
      const UpdateConfigurationPolicyRequestT& request) const {
    return SubmitCallable(&SecurityHubClient::UpdateConfigurationPolicy, request);
  }

  /**
   * An Async wrapper for UpdateConfigurationPolicy that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateConfigurationPolicyRequestT = Model::UpdateConfigurationPolicyRequest>
  void UpdateConfigurationPolicyAsync(const UpdateConfigurationPolicyRequestT& request,
  ...
  /**
   * A Callable wrapper for UpdateConnectorV2 that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateConnectorV2 that queues the request into a thread executor and triggers associated callback when operation
   * has finished.
   */
  template <typename UpdateConnectorV2RequestT = Model::UpdateConnectorV2Request>
  void UpdateConnectorV2Async(const UpdateConnectorV2RequestT& request, const UpdateConnectorV2ResponseReceivedHandler& handler,
                              const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateFindingAggregator that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateFindingAggregator that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateFindingAggregatorRequestT = Model::UpdateFindingAggregatorRequest>
  void UpdateFindingAggregatorAsync(const UpdateFindingAggregatorRequestT& request,
  ...
  /**
   * An Async wrapper for UpdateFindings that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateFindingsRequestT = Model::UpdateFindingsRequest>
  void UpdateFindingsAsync(const UpdateFindingsRequestT& request, const UpdateFindingsResponseReceivedHandler& handler,
                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * An Async wrapper for UpdateInsight that queues the request into a thread executor and triggers associated callback when operation has
   * finished.
   */
  template <typename UpdateInsightRequestT = Model::UpdateInsightRequest>
  void UpdateInsightAsync(const UpdateInsightRequestT& request, const UpdateInsightResponseReceivedHandler& handler,
                          const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
  ...
  /**
   * A Callable wrapper for UpdateSecurityControl that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateSecurityControl that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateSecurityControlRequestT = Model::UpdateSecurityControlRequest>
  void UpdateSecurityControlAsync(const UpdateSecurityControlRequestT& request, const UpdateSecurityControlResponseReceivedHandler& handler,
                                  const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr) const {
   ...
   * API Reference</a></p>
   */
  virtual Model::UpdateSecurityHubConfigurationOutcome UpdateSecurityHubConfiguration(
      const Model::UpdateSecurityHubConfigurationRequest& request = {}) const;

  /**
   * A Callable wrapper for UpdateSecurityHubConfiguration that returns a future to the operation so that it can be executed in parallel to
   * other requests.
   */
  template <typename UpdateSecurityHubConfigurationRequestT = Model::UpdateSecurityHubConfigurationRequest>
  Model::UpdateSecurityHubConfigurationOutcomeCallable UpdateSecurityHubConfigurationCallable(
      const UpdateSecurityHubConfigurationRequestT& request = {}) const {
    return SubmitCallable(&SecurityHubClient::UpdateSecurityHubConfiguration, request);
  }

  /**
   * An Async wrapper for UpdateSecurityHubConfiguration that queues the request into a thread executor and triggers associated callback
   * when operation has finished.
   */
  template <typename UpdateSecurityHubConfigurationRequestT = Model::UpdateSecurityHubConfigurationRequest>
  void UpdateSecurityHubConfigurationAsync(const UpdateSecurityHubConfigurationResponseReceivedHandler& handler,
                                           const std::shared_ptr<const Aws::Client::AsyncCallerContext>& context = nullptr,
                                           const UpdateSecurityHubConfigurationRequestT& request = {}) const {
  ...
  /**
   * A Callable wrapper for UpdateStandardsControl that returns a future to the operation so that it can be executed in parallel to other
   * requests.
   */
  ...
  /**
   * An Async wrapper for UpdateStandardsControl that queues the request into a thread executor and triggers associated callback when
   * operation has finished.
   */
  template <typename UpdateStandardsControlRequestT = Model::UpdateStandardsControlRequest>
  void UpdateStandardsControlAsync(const UpdateStandardsControlRequestT& request,

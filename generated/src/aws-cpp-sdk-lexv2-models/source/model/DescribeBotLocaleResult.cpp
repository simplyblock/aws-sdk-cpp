...
DescribeBotLocaleResult::DescribeBotLocaleResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }
...
DescribeBotLocaleResult& DescribeBotLocaleResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {
  ...
  if (jsonValue.ValueExists("botLocaleHistoryEvents")) {
    ...
    for (unsigned botLocaleHistoryEventsIndex = 0; botLocaleHistoryEventsIndex < botLocaleHistoryEventsJsonList.GetLength();
         ++botLocaleHistoryEventsIndex) {

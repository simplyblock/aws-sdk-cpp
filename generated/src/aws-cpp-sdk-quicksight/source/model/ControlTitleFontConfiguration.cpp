...
ControlTitleFontConfiguration::ControlTitleFontConfiguration(JsonView jsonValue) { *this = jsonValue; }

ControlTitleFontConfiguration& ControlTitleFontConfiguration::operator=(JsonView jsonValue) {
...
JsonValue ControlTitleFontConfiguration::Jsonize() const {
  JsonValue payload;

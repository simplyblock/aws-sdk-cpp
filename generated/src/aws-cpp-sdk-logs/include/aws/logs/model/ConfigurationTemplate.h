...
class ConfigurationTemplate {
 public:
  ...
  inline ConfigurationTemplate& WithDeliveryDestinationType(DeliveryDestinationType value) {
  ...
  void SetDefaultDeliveryConfigValues(DefaultDeliveryConfigValuesT&& value) {
    ...
    m_defaultDeliveryConfigValues = std::forward<DefaultDeliveryConfigValuesT>(value);
  }
  template <typename DefaultDeliveryConfigValuesT = ConfigurationTemplateDeliveryConfigValues>
  ConfigurationTemplate& WithDefaultDeliveryConfigValues(DefaultDeliveryConfigValuesT&& value) {
    SetDefaultDeliveryConfigValues(std::forward<DefaultDeliveryConfigValuesT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAllowedOutputFormats(AllowedOutputFormatsT&& value) {
    ...
    m_allowedOutputFormats = std::forward<AllowedOutputFormatsT>(value);
  }
  template <typename AllowedOutputFormatsT = Aws::Vector<OutputFormat>>
  ConfigurationTemplate& WithAllowedOutputFormats(AllowedOutputFormatsT&& value) {
    SetAllowedOutputFormats(std::forward<AllowedOutputFormatsT>(value));
    return *this;
  }
  inline ConfigurationTemplate& AddAllowedOutputFormats(OutputFormat value) {
    m_allowedOutputFormatsHasBeenSet = true;
    m_allowedOutputFormats.push_back(value);
    return *this;
  }
  ///@}
   ...
   */
  inline const Aws::String& GetAllowedActionForAllowVendedLogsDeliveryForResource() const {
    return m_allowedActionForAllowVendedLogsDeliveryForResource;
  }
  inline bool AllowedActionForAllowVendedLogsDeliveryForResourceHasBeenSet() const {
    return m_allowedActionForAllowVendedLogsDeliveryForResourceHasBeenSet;
  }
  ...
  void SetAllowedActionForAllowVendedLogsDeliveryForResource(AllowedActionForAllowVendedLogsDeliveryForResourceT&& value) {
    ...
    m_allowedActionForAllowVendedLogsDeliveryForResource = std::forward<AllowedActionForAllowVendedLogsDeliveryForResourceT>(value);
  }
  template <typename AllowedActionForAllowVendedLogsDeliveryForResourceT = Aws::String>
  ConfigurationTemplate& WithAllowedActionForAllowVendedLogsDeliveryForResource(
      AllowedActionForAllowVendedLogsDeliveryForResourceT&& value) {
    SetAllowedActionForAllowVendedLogsDeliveryForResource(std::forward<AllowedActionForAllowVendedLogsDeliveryForResourceT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAllowedFieldDelimiters(AllowedFieldDelimitersT&& value) {
    ...
    m_allowedFieldDelimiters = std::forward<AllowedFieldDelimitersT>(value);
  }
  template <typename AllowedFieldDelimitersT = Aws::Vector<Aws::String>>
  ConfigurationTemplate& WithAllowedFieldDelimiters(AllowedFieldDelimitersT&& value) {
    SetAllowedFieldDelimiters(std::forward<AllowedFieldDelimitersT>(value));
    return *this;
  }
  ...
  ConfigurationTemplate& AddAllowedFieldDelimiters(AllowedFieldDelimitersT&& value) {
    m_allowedFieldDelimitersHasBeenSet = true;
    m_allowedFieldDelimiters.emplace_back(std::forward<AllowedFieldDelimitersT>(value));
    return *this;
  }
  ///@}
  ...
  void SetAllowedSuffixPathFields(AllowedSuffixPathFieldsT&& value) {
    ...
    m_allowedSuffixPathFields = std::forward<AllowedSuffixPathFieldsT>(value);
  }
  template <typename AllowedSuffixPathFieldsT = Aws::Vector<Aws::String>>
  ConfigurationTemplate& WithAllowedSuffixPathFields(AllowedSuffixPathFieldsT&& value) {
    SetAllowedSuffixPathFields(std::forward<AllowedSuffixPathFieldsT>(value));
    return *this;
  }
  ...
  ConfigurationTemplate& AddAllowedSuffixPathFields(AllowedSuffixPathFieldsT&& value) {
    m_allowedSuffixPathFieldsHasBeenSet = true;
    m_allowedSuffixPathFields.emplace_back(std::forward<AllowedSuffixPathFieldsT>(value));
    return *this;
  }
  ///@}

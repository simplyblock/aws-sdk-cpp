...
ConfigurationTemplate::ConfigurationTemplate(JsonView jsonValue) { *this = jsonValue; }
...
ConfigurationTemplate& ConfigurationTemplate::operator=(JsonView jsonValue) {
  ...
  if (jsonValue.ValueExists("allowedOutputFormats")) {
    ...
    for (unsigned allowedOutputFormatsIndex = 0; allowedOutputFormatsIndex < allowedOutputFormatsJsonList.GetLength();
         ++allowedOutputFormatsIndex) {
      m_allowedOutputFormats.push_back(
          OutputFormatMapper::GetOutputFormatForName(allowedOutputFormatsJsonList[allowedOutputFormatsIndex].AsString()));
    }
  ...
  if (jsonValue.ValueExists("allowedFieldDelimiters")) {
    ...
    for (unsigned allowedFieldDelimitersIndex = 0; allowedFieldDelimitersIndex < allowedFieldDelimitersJsonList.GetLength();
         ++allowedFieldDelimitersIndex) {
  ...
  if (jsonValue.ValueExists("allowedSuffixPathFields")) {
    ...
    for (unsigned allowedSuffixPathFieldsIndex = 0; allowedSuffixPathFieldsIndex < allowedSuffixPathFieldsJsonList.GetLength();
         ++allowedSuffixPathFieldsIndex) {
...
JsonValue ConfigurationTemplate::Jsonize() const {
  ...
  if (m_allowedOutputFormatsHasBeenSet) {
    ...
    for (unsigned allowedOutputFormatsIndex = 0; allowedOutputFormatsIndex < allowedOutputFormatsJsonList.GetLength();
         ++allowedOutputFormatsIndex) {
      allowedOutputFormatsJsonList[allowedOutputFormatsIndex].AsString(
          OutputFormatMapper::GetNameForOutputFormat(m_allowedOutputFormats[allowedOutputFormatsIndex]));
    }

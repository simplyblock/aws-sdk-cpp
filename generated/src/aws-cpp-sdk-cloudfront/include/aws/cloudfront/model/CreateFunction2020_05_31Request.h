...
class CreateFunction2020_05_31Request : public CloudFrontRequest {
 public:
  ...
  void SetFunctionConfig(FunctionConfigT&& value) {
    ...
    m_functionConfig = std::forward<FunctionConfigT>(value);
  }
  template <typename FunctionConfigT = FunctionConfig>
  CreateFunction2020_05_31Request& WithFunctionConfig(FunctionConfigT&& value) {
    SetFunctionConfig(std::forward<FunctionConfigT>(value));
    return *this;
  }
  ///@}
  ...
  void SetFunctionCode(FunctionCodeT&& value) {
    ...
    m_functionCode = std::forward<FunctionCodeT>(value);
  }
  template <typename FunctionCodeT = Aws::Utils::CryptoBuffer>
  CreateFunction2020_05_31Request& WithFunctionCode(FunctionCodeT&& value) {
    SetFunctionCode(std::forward<FunctionCodeT>(value));
    return *this;
  }
  ///@}

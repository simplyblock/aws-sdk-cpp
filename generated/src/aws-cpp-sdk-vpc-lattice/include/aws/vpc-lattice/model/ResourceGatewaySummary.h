...
class ResourceGatewaySummary {
 public:
  ...
  inline ResourceGatewaySummary& WithStatus(ResourceGatewayStatus value) {
    SetStatus(value);
    return *this;
  }
  ///@}
  ...
  inline ResourceGatewaySummary& WithIpAddressType(ResourceGatewayIpAddressType value) {
  ...
  inline ResourceGatewaySummary& WithIpv4AddressesPerEni(int value) {

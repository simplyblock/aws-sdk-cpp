...
class GetDomainSuggestionsRequest : public Route53DomainsRequest {
 public:
  ...
  inline void SetSuggestionCount(int value) {
    m_suggestionCountHasBeenSet = true;
    m_suggestionCount = value;
  }
  inline GetDomainSuggestionsRequest& WithSuggestionCount(int value) {
  ...
  inline void SetOnlyAvailable(bool value) {
    m_onlyAvailableHasBeenSet = true;
    m_onlyAvailable = value;
  }
  inline GetDomainSuggestionsRequest& WithOnlyAvailable(bool value) {

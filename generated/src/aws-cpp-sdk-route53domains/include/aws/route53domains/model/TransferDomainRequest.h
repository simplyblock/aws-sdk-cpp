...
class TransferDomainRequest : public Route53DomainsRequest {
 public:
  ...
  ///@{
  /**
   * <p>Reserved for future use.</p> <p>Currently, the effect of a domain transfer on
   * the registration period varies by TLD. For information about how transferring a
   * domain affects the expiration date, see the Transfer Term column in the pricing
   * information at <a href="http://aws.amazon.com/route53/pricing/">Amazon Route 53
   * Pricing</a>.</p> <p>Default: 1</p>
   */
  ...
  inline void SetDurationInYears(int value) {
    m_durationInYearsHasBeenSet = true;
    m_durationInYears = value;
  }
  inline TransferDomainRequest& WithDurationInYears(int value) {
    SetDurationInYears(value);
    return *this;
  }
  ///@}
  ...
  inline TransferDomainRequest& WithAutoRenew(bool value) {
    SetAutoRenew(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPrivacyProtectAdminContact(bool value) {
    m_privacyProtectAdminContactHasBeenSet = true;
    m_privacyProtectAdminContact = value;
  }
  inline TransferDomainRequest& WithPrivacyProtectAdminContact(bool value) {
    SetPrivacyProtectAdminContact(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPrivacyProtectRegistrantContact(bool value) {
    m_privacyProtectRegistrantContactHasBeenSet = true;
    m_privacyProtectRegistrantContact = value;
  }
  inline TransferDomainRequest& WithPrivacyProtectRegistrantContact(bool value) {
    SetPrivacyProtectRegistrantContact(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPrivacyProtectTechContact(bool value) {
    m_privacyProtectTechContactHasBeenSet = true;
    m_privacyProtectTechContact = value;
  }
  inline TransferDomainRequest& WithPrivacyProtectTechContact(bool value) {
    SetPrivacyProtectTechContact(value);
    return *this;
  }
  ///@}
  ...
  inline void SetPrivacyProtectBillingContact(bool value) {
    m_privacyProtectBillingContactHasBeenSet = true;
    m_privacyProtectBillingContact = value;
  }
  inline TransferDomainRequest& WithPrivacyProtectBillingContact(bool value) {
    SetPrivacyProtectBillingContact(value);
    return *this;
  }
  ///@}
 private:

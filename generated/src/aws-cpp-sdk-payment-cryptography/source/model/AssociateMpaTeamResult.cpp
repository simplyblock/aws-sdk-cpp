...
AssociateMpaTeamResult::AssociateMpaTeamResult(const Aws::AmazonWebServiceResult<JsonValue>& result) { *this = result; }

AssociateMpaTeamResult& AssociateMpaTeamResult::operator=(const Aws::AmazonWebServiceResult<JsonValue>& result) {

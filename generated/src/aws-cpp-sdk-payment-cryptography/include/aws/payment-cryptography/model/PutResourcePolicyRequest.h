...
/**
 */
class PutResourcePolicyRequest : public PaymentCryptographyRequest {
 public:
  AWS_PAYMENTCRYPTOGRAPHY_API PutResourcePolicyRequest() = default;
  ...
  ///@{
  /**
   * <p>The <code>KeyARN</code> of the key to attach the resource-based policy
   * to.</p>
   */

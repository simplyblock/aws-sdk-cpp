...
/**
 */
class AssociateMpaTeamRequest : public PaymentCryptographyRequest {
 public:
  ...
  inline virtual const char* GetServiceRequestName() const override { return "AssociateMpaTeam"; }
  ...
  ///@{
  /**
   * <p>The protected operation to associate with the MPA team. Currently, the only
   * supported value is <code>IMPORT_ROOT_PUBLIC_KEY_CERTIFICATE</code>.</p>
   */
  ...
  inline AssociateMpaTeamRequest& WithAction(MpaOperation value) {
    SetAction(value);
    return *this;
  }
  ///@}
  ...
  ///@{
  /**
   * <p>The comment from the requester explaining the reason for the association.</p>

...
/**
 */
class DeleteResourcePolicyRequest : public PaymentCryptographyRequest {
 public:
  AWS_PAYMENTCRYPTOGRAPHY_API DeleteResourcePolicyRequest() = default;
  ...
  ///@{
  /**
   * <p>The <code>KeyARN</code> of the key whose resource-based policy you want to
   * delete.</p>
   */
